...
> - **[kernel-patch-fetch](file://~/.qoder/skills/kernel-patch-fetch/SKILL.md)**：负责通过 NNTP 拉取 patch 数据并生成 Markdown 报表
> - **[yuque-doc-writer](file://~/.qoder/skills/yuque-doc-writer/SKILL.md)**：负责将 Markdown 内容写入语雀知识库
...
调用 **[kernel-patch-fetch](file://~/.qoder/skills/kernel-patch-fetch/SKILL.md)** 子 skill：

```bash
python3 ~/.qoder/skills/kernel-patch-fetch/scripts/fetch_patches.py \
...
调用 **[yuque-doc-writer](file://~/.qoder/skills/yuque-doc-writer/SKILL.md)** 子 skill：

```bash
python3 ~/.qoder/skills/yuque-doc-writer/scripts/yuque_doc.py \
